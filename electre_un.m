...
=======
%%%Script permettant le déroulement de l'analyse multicritère
%suivant la méthode Electre I.
...
col_1_ech = col_1 *(b2-a2)/(b1-a1)+(b1*a2-a1*b2)/(b1-a1);
col_3_ech = col_3 *(b2-a2)/(b1-a1)+(b1*a2-a1*b2)/(b1-a1);
%Nous utilisons la formule : y = x*(b2-a2)/(b1-a1)+(b1*a2-a1*b2)/(b1-a1);
...
%Itération 2
M_S2 = matrice_surclassement(M_C, M_D, 0.75, 0.3);
>>>>>>> Stashed changes:analyse_multicritere/electre_un.m
